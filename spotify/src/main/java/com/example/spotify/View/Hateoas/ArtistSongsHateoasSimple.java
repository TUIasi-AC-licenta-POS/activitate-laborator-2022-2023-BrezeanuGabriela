...
@Component
public class ArtistSongsHateoasSimple implements RepresentationModelAssembler<ArtistSongsDTO, EntityModel<ArtistSongsDTO>> {
    @Override
    public EntityModel<ArtistSongsDTO> toModel(ArtistSongsDTO artist) {
