...
@Component
public class MusicHateoasVerySimple implements RepresentationModelAssembler<SimpleMusicDTO, EntityModel<SimpleMusicDTO>>{

    @Override
    public EntityModel<SimpleMusicDTO> toModel(SimpleMusicDTO music) {
