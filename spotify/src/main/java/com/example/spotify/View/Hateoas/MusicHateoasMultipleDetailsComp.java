...
@Component
public class MusicHateoasMultipleDetailsComp implements RepresentationModelAssembler<MusicWithAlbumSongsDTO, EntityModel<MusicWithAlbumSongsDTO>> {

    @Override
    public EntityModel<MusicWithAlbumSongsDTO> toModel(MusicWithAlbumSongsDTO music) {
